...
public class TestHiveIcebergStorageHandler {
  ...
  public void testScanEmptyTable() throws IOException {
    ...
    createIcebergStorageHandlerBasedHiveTable("empty", emptyTable.location());
  ...
  public void testScanTable() {
    createIcebergStorageHandlerBasedHiveTable("customers", customerTable.location());
  ...
  public void testJoinTables() {
    createIcebergStorageHandlerBasedHiveTable("customers", customerTable.location());
    createIcebergStorageHandlerBasedHiveTable("orders", orderTable.location());
  ...
  private void createIcebergStorageHandlerBasedHiveTable(String table, String location) {
    shell.execute(String.format(
        "CREATE TABLE default.%s " +
            "ROW FORMAT SERDE '%s'" +
            "STORED BY 'org.apache.iceberg.mr.mapred.IcebergStorageHandler' " +
            "LOCATION '%s'",
        table, IcebergSerDe.class.getName(), location));
  }
